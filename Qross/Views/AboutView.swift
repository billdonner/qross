            ...
            ScrollView {
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 0) {
                        ...
                        Divider().padding(.leading, 52)
                        featureRow("sparkles", "AI Move Advisor", "Smart suggestions with risk ratings and dead-end detection", .indigo)
                        Divider().padding(.leading, 52)
                        featureRow("star.fill", "Score & Compete", "Game Center leaderboards and shareable results", .green)
                        Divider().padding(.leading, 52)
                        featureRow("gearshape", "Settings", "Board size, variant, mode, haptics, and more", .gray)
                        Divider().padding(.leading, 52)
